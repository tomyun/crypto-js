YUI.add('algo-pbkdf2-test', function (Y) {
    ...
    Y.Test.Runner.add(new Y.Test.Case({
        ...
        testKeySize128: function () {
            var actual = C.algo.PBKDF2.compute('password', 'ATHENA.MIT.EDUraeburn', { keySize: 128/32 });

            Y.Assert.areEqual('cdedb5281bb2f801565a1122b2563515', actual);
        },

        testKeySize256: function () {
            var actual = C.algo.PBKDF2.compute('password', 'ATHENA.MIT.EDUraeburn', { keySize: 256/32 });
        ...
        testKeySize128Iterations2: function () {
            ...
            var actual = C.algo.PBKDF2.compute('password', 'ATHENA.MIT.EDUraeburn', cfg);
        ...
        testKeySize128Iterations5: function () {
            ...
            var actual = C.algo.PBKDF2.compute('password', salt, { keySize: 128/32, iterations: 5 });
        ...
        testKeySize256Iterations5: function () {
            var salt = C.enc.Hex.fromString('1234567878563412');
            var actual = C.algo.PBKDF2.compute('password', salt, { keySize: 256/32, iterations: 5 });
        ...
        testKeySize128Iterations1200PassPhraseEqualsBlockSize: function () {
            ...
            var actual = C.algo.PBKDF2.compute(password, salt, { keySize: 128/32, iterations: 1200 });
        ...
        testKeySize256Iterations1200PassPhraseEqualsBlockSize: function () {
            var password = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
            var salt = 'pass phrase equals block size';
            var actual = C.algo.PBKDF2.compute(password, salt, { keySize: 256/32, iterations: 1200 });
        ...
        testKeySize128Iterations50: function () {
            ...
            var actual = C.algo.PBKDF2.compute(password, 'EXAMPLE.COMpianist', cfg);
        ...
        testInputIntegrity: function () {
            ...
            C.algo.PBKDF2.compute(password, salt);
