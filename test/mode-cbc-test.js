YUI.add('mode-cbc-test', function (Y) {
    ...
    Y.Test.Runner.add(new Y.Test.Case({
        ...
        testEncryptor: function () {
            ...
            // Compute actual
            var actual = C.AES.encrypt(message, key, { iv: iv, mode: C.mode.CBC, padding: C.pad.NoPadding }).ciphertext;
        ...
        testDecryptor: function () {
            ...
            var encrypted = C.AES.encrypt(message, key, { iv: iv, mode: C.mode.CBC, padding: C.pad.NoPadding });
            var decrypted = C.AES.decrypt(encrypted, key, { iv: iv, mode: C.mode.CBC, padding: C.pad.NoPadding });
